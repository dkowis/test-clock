image::https://github.com/dkowis/test-clock/actions/workflows/java-ci.yml/badge.svg[Build Workflow]
...
- Originally by Rob Fletcher at https://github.com/robfletcher/test-clock
- Updated 2022 by David Kowis at https://github.com/dkowis/test-clock
